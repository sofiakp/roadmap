...
write.table(Output,file="Promoter_Enhancer_Corr_Agg.txt",sep="\t")
...
write.table(Output,file="Promoter_H3K4me1_Corr_Agg.txt",sep="\t")
...
write.table(Output,file="Promoter_H3K4me3_Corr_Agg.txt",sep="\t")
...
write.table(Output,file="Enhancer_H3K4me1_Corr_Agg.txt",sep="\t")
...
write.table(Output,file="Enhancer_H3K4me3_Corr_Agg.txt",sep="\t")
